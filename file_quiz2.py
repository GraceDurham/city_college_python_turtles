...
# 1.# What will be returned when we use readlines() method with a file object created for opening a file.
# answer is returns a list of all the lines in the file []

# 2. Imagine you have a text file in which the entire contents reads as "Reads and returns a string of 
...
# 3. Write a python function to count how many lines in a given text file. Inside your function, first do 
...
def count_lines_list_comprehension(fileobject):
	"""reads number if lines in a file with list comprehension"""
...
#4 Write a python function to return the word count of a given text file. Inside your function, do this 
